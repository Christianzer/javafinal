...
public class DossierCacao {
    ...
    public DossierCacao(int docrecomp, String nomrecomp, String prenomsrecomp, double resultatMoye, int classement, int resultatvaleur) {
        this.docrecomp = docrecomp;
        this.nomrecomp = nomrecomp;
        this.prenomsrecomp = prenomsrecomp;
        this.resultatMoye = resultatMoye;
